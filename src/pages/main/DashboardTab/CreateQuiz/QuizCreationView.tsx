...
import useCreateQuiz from '#pages/main/DashboardTab/hooks/useCreateQuiz';
import QuestionListView from '#pages/main/DashboardTab/QuestionListView';
...
export default function QuizCreationView(props: QuizCreationViewProps) {
	...
	const { state, totalPoints, quizLoader, setQuizLoader, loadQuiz, confirmCreate, reset } =
		...
		<div className="flex h-full flex-col justify-between">
			...
			{state.isLoading ? (
				...
				<div className="overflow-y-scroll">
					<QuestionListView questions={state.newQuiz.questions} readOnly />
				</div>
			) : (
			...
			<div className="flex flex-col gap-3 px-5 pt-4 pb-6">
				...
				<div className="flex justify-between gap-3">
					...
					{state.newQuiz ? (
						<Button variant="solid" onClick={confirmCreate}>
							Create
						</Button>
					) : (
						<Button
							variant="solid"
							disabled={state.isLoading || quizLoader.payload === null}
							onClick={loadQuiz}
						>
