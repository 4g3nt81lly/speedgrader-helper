...
export default function RubricListEditor(props: RubricListEditorProps) {
	...
	function addRubricItem() {
		...
		updateRubric(Rubric.addItem(rubric, newItem));
	}
	...
	function handleEndEditing(newRubricItem: Nullable<IRubricItem>) {
		if (newRubricItem) {
			updateRubric(Rubric.updateItem(rubric, newRubricItem));
		}
		setDraftItemId(null);
	}
	...
	function handleRemoveRubricItem(rubricItemId: string) {
		...
		updateRubric(Rubric.removeItem(rubric, rubricItemId));
	}
	...
	function endReordering(commit: boolean) {
		if (!orderedRubricItems) return;
		if (commit) {
			updateRubric(Rubric.updateItems(rubric, orderedRubricItems));
		}
